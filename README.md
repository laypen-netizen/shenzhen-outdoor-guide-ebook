...
- 74 张授权实景图逐张保留作者、许可与来源；另有 2 张来源实景图明确标注“许可待核验”，深圳自然博物馆另含 1 张用户提供建筑图，原始版权信息待补充；其余 276 张景点主图明确标注为“编辑配图·非现场实景”（本批图片来源与许可见 `docs/real-photo-sourcing-2026-08-01.md`）
