...
- 331 个独立景点专页，完整保留介绍、亮点、适合人群、首次游览建议、票务、交通、停车、季节气候、开放状态与图片来源
- 深圳 10 个行政区 / 新区专题页
- 69 家博物馆、20 处美术空间
...
- 69 张授权实景图逐张保留作者、许可与来源；深圳自然博物馆另含 1 张用户提供建筑图及 3 张用户提供参考图，原始版权信息待补充；其余 261 张景点主图明确标注为“编辑配图·非现场实景”

## 页面结构

- `index.html`：首页与十区入口
- `places/index.html`：331 个景点的可筛选目录
- `places/001/`—`places/331/`：景点详情页
- `districts/`：十区专题页
...
- `assets/gallery/`：仅存放详情页补充图示；用户提供图片会明确标注来源与版权信息待补充
